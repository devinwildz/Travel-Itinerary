        ...
        <div className="p-4 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-border/50">
            ...
            <motion.button
              ...
              className="px-3 py-2 rounded-xl cursor-pointer bg-gradient-to-r from-primary to-accent text-primary-foreground text-sm font-semibold hover:shadow-lg hover:shadow-primary/50 transition-all"
            >
              Contact Us
            </motion.button>
          </div>
